...
#SBATCH -N 1
#SBATCH -n 32
#SBATCH -o ../results/ml_classical_models/running_xbox_weighted_inc.log        # %N for name of 1st allocated node
...
--infile ../data/dimer_updated_with_madin_bowman_0.10_weights.csv \
--weighted \
--models SVR \
