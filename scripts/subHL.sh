...
#SBATCH -N 1
#SBATCH -n 32
#SBATCH -o ../results/ml_classical_models/running_HL.log        # %N for name of 1st allocated node
...
--infile ../data/dimer_updated_with_madin_bowman_L25.csv \
--outdir ../results/ml_classical_models/ 

python run_model_evaluation_save_foldindex.py \
--infile ../data/dimer_updated_with_madin_bowman_H25.csv \
--outdir ../results/ml_classical_models/ 
