...
#SBATCH -N 1
#SBATCH -n 32
#SBATCH -o ../results/ml_classical_models/running_kds.log        # %N for name of 1st allocated node
...
--infile ../data/dimer_updated_with_madin_bowman_kingdom_archaea.csv \
--outdir ../results/ml_classical_models/ 

python run_model_evaluation_save_foldindex.py \
--infile ../data/dimer_updated_with_madin_bowman_kingdom_eukaryota.csv \
--outdir ../results/ml_classical_models/ 

python run_model_evaluation_save_foldindex.py \
--infile ../data/dimer_updated_with_madin_bowman_kingdom_bacteria.csv \
--outdir ../results/ml_classical_models/ 